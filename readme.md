...
This mod makes the [Space Exploration](https://mods.factorio.com/mod/space-exploration) spaceships available the same time as Cargo Rockets, and adjusts further technologies accordingly. Theoretically you never need to build a Cargo Rocket. The goal is to allow you to build your entire interplanetary logistics infrastructure using spaceships from the start. This is now easier than ever since the addition of the spaceship scheduler allowing you to control spaceships like trains.

# Changes
- Spaceship technology now locked behind Rocket Science, just like the Cargo Rocket.
- Spaceship Clamp and Integrity technologies are now locked behind Space Science.
- Spaceship Ion Engine is now locked behind Utility and Production Science.
...
- [Earendel](https://mods.factorio.com/user/Earendel) who made Space Exploration, my favourite mod.
